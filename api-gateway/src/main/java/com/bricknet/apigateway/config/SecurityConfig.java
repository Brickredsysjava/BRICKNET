    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http){
            return http
                    ...
                    .authorizeExchange(authorizeExchangeSpec -> authorizeExchangeSpec
                            ...
                            .pathMatchers("/user/**","/communityPost/admin/**","/suggestionPost/api/**","/community/post/**","/community/post/getAllPosts" ,"/send/**", "user/profile/profileFromUserName/**" , "/api/broadcasting/**", "/api/to-do/**", "/media/**", "/suggestionPost/api/suggestions/**").permitAll()
