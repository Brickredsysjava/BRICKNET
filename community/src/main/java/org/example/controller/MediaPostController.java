...
public class MediaPostController {
    ...
    @PostMapping("/addMediaPost")
    @ResponseBody
    public String handleMediaUpload(@RequestPart List<MultipartFile> files, @RequestPart String title,@RequestPart String employeeCode, @RequestPart String description) throws CommunityException, ServiceNotFoundException {
        ...
        Community communityPost = Community.builder()
                ...
                .build();
//        Community communityPost = new Community();
...
//        communityPost.setAdminVerificationStatus(false);
   ...
   @PutMapping("updateMedia")
    public ResponseEntity<String> updateMedia(@RequestParam String post_id, @RequestPart List<MultipartFile> files, @RequestParam String employeeCode, @RequestPart String title, @RequestPart String description) throws CommunityException, IOException, ServiceNotFoundException {
